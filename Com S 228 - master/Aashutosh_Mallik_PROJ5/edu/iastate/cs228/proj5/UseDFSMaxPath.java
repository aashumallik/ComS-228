...
public class UseDFSMaxPath {
    public static void main(String[] args) {
        ...
        // The next part may take a few seconds and can be commented out on your
        // first try.
        ...
        Stack<Integer> topo = DFS.depthFirstSearch(big);
        if (topo == null)
            System.out.println("The graph has a cycle");
        Stack<Integer> ipath = new Stack<Integer>();
        System.out.println("Distance of a max path: " +
                MaxPath.findMaxPath(big, ipath));
    }
}
